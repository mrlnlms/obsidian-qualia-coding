...
export class WaveformRenderer {
  ...
  create(container: HTMLElement, media: HTMLMediaElement): void {
    this.destroy();
    ...
    minimapWrapper.className = 'codemarker-video-minimap-wrapper';
    container.prepend(minimapWrapper);

    this.minimapOverlay = document.createElement('div');
    this.minimapOverlay.className = 'codemarker-video-minimap-overlay';
