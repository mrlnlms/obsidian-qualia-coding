/**
 * PDF Code Detail View — sidebar with 3 modes: list, code-focused, marker-focused.
 * Adapted from csvCodeDetailView.ts.
 */
...
export class PdfCodeDetailView extends ItemView {
