...
// settings/suggesters/suggest.ts
...
var SampleSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  add_template_folder_setting() {
    new import_obsidian3.Setting(this.containerEl).setName("Template folder location").setDesc("Files in this folder will be available as templates.").addSearch((cb) => {
...
var MyPlugin = class extends import_obsidian4.Plugin {
  async onload() {
    ...
    this.registerEvent(this.app.workspace.on("active-leaf-change", () => {
      new import_obsidian4.Notice("active-leaf-change'");
  ...
  performActionBasedOnCode(code) {
    new import_obsidian4.Notice(`Action performed for code: ${code}`);
  }
