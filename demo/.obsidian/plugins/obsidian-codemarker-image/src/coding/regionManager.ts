...
export class RegionManager {
	...
	registerShape(shape: FabricObject, file: string): ImageMarker | null {
		...
		const marker = this.model.createMarker(file, shapeType, coords);
	...
	restoreMarkers(file: string): void {
		const markers = this.model.getMarkersForFile(file);
