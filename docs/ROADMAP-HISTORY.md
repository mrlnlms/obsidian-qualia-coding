# Qualia Coding — Roadmap (HISTORY)

> **📦 Snapshot pareado de 2026-05-13** — preservado antes do cleanup. Conteúdo do ROADMAP em estado pareado (Fase 1 completa, 12 inconsistências resolvidas via bannerização sem mover conteúdo).
>
> **Como ler este arquivo:**
> - **ROADMAP.md atual** = versão enxuta operacional (só estado vivo: status atual + frentes ativas + decisões cravadas + won't-fix + permanente)
> - **ROADMAP-HISTORY.md (este arquivo)** = arqueologia completa: decisões substituídas, slices entregues em detalhe (Slice 1-6 + E1-E5b + Fase C), brainstorms passados, design docs anteriores, repertório histórico de Ângulo A/B ICR, pesquisa LLM original com 5 escolas filosóficas, design A/B/C/D dos memos, escopo Drag Code Explorer entregue
> - Buscar por palavra-chave (`Slice E3a`, `Convivência A+B`, `5 escolas filosóficas`, etc.) pra encontrar referência arqueológica
> - Para o estado atual cravado de qualquer tópico, consultar primeiro `ROADMAP.md` (curto)
> - Tag git `pre-roadmap-cleanup` aponta pro commit deste snapshot
>
> **Quando este arquivo se atualiza:** quando algo sai do ROADMAP vivo (decisão substituída, frente fechada com detalhe grande, design doc obsoleto). Não acumula commits diários — só transferências de conteúdo do vivo pro histórico.

---

## 📑 Índice

- [Status atual (snapshot 2026-05-13)](#-status-atual-próxima-sessão-lê-isso-primeiro)
- [Frentes 1/2/3 + Submissão Community Plugins](#frente-1--icr--fechada-2026-05-13-release-060-arquitetura--070-gaps-intra-modality)
- [🧱 ICR — Itens em aberto (zerada — lista historiográfica de 13 slices entregues)](#-icr--itens-em-aberto-canonical-list--zerada-2026-05-13)
- [🗺️ Áreas de trabalho](#️-áreas-de-trabalho)
- [❓ Decisões de produto abertas (com histórico de Infra ICR)](#-decisões-de-produto-abertas)
- [Detalhes — Coding Management / Analytics / Margin Panel](#detalhes--roadmap)
- [Parquet/CSV lazy loading (post-mortem)](#parquetcsv-lazy-loading)
- [Framework Unificado ICR + LLM](#framework-unificado-icr--llm-cravado-2026-05-13)
- [LLM-assisted coding (repertório histórico 2026-05-01)](#llm-assisted-coding)
- [Intercoder Reliability (repertório histórico 2026-05-04, Ângulo A/B)](#intercoder-reliability--material-de-repertório-pra-discussão-epistemológica)
- [Q-mode / P-mode analytics (era frente #1 em 2026-05-04)](#q-mode--p-mode-analytics--próxima-frente-engatilhada)
- [Projects + Workspace](#projects--workspace)
- [Research Board Enhancements](#research-board-enhancements)
- [Analytical Memos (design A/B/C/D histórico)](#analytical-memos)
- [Riscos / Items permanentes / Decisões fechadas / Implementados](#riscos)

---

# Qualia Coding — Roadmap (conteúdo original pareado)
