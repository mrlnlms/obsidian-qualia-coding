...
- [ ] **Decisão metodológica: manter δ linear (atual) OU migrar pra δ² canônica em α com Jaccard/MASI?** Divergência detectada em characterization tests 2026-05-13. Trade-off: (a) manter δ linear preserva valores publicados em release 0.5.0/0.6.0 (estabilidade) — alinhado com Passonneau 2006 original e várias impls subsequentes; (b) migrar pra δ² alinha com canon estrita Krippendorff 2018 cap. 11 — exige release de bugfix + nota metodológica + recalibrar tests. Para δ_nominal não há diferença (δ=δ²). **Não atacar sem decisão explícita do user.**
