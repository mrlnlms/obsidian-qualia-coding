...
- **Intercoder Reliability (kappa/alpha)** — `quallmer` (R) tem referência matemática. Acopla bem com LLM (humano-vs-LLM kappa é caso forte). Atacar antes de LLM é viável mas perde alavancagem.
