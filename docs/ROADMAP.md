...
|------|------------------|
| **[Coding Management](#2-coding-management)** | Tier 1: multi-select / bulk ops (incl. bulk rename) / drag-drop inter-groups · Tier 2: audit log / code merging avançado · Tier 3 (bloqueado por LLM): Smart Codes |
...
| **Bulk operations** | Aplicar ação em N códigos selecionados: move folder, add group, recolor, delete, **rename** (add before / add after — ver nota abaixo) | Multi-select |
