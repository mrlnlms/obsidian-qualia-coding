...
|------|------------------|
| **[Coding Management](#2-coding-management)** | Tier 1: multi-select / bulk ops (incl. bulk rename) · Tier 2: audit log / code merging avançado · Tier 3 (bloqueado por LLM): Smart Codes |
