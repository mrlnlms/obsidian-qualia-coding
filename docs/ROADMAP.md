...
|------|------------------|
| **[Coding Management](#2-coding-management)** | Tier 1: bulk ops (incl. bulk rename) · Tier 2: audit log / code merging avançado · Tier 3 (bloqueado por LLM): Smart Codes |
...
| **Bulk operations** (resto) | Aplicar ação em N códigos selecionados: move folder, add group, recolor, **rename** (add before / add after — ver nota abaixo). Delete já feito no #27 | Multi-select ✅ |
